...
#   icon: fas fa-scroll
- name: Preprint
  url: /papers/chrisendonivahoffmannrochasandstromsoltkummu2024_pre
  icon: far fa-file-pdf
- name: Code
  url: "https://github.com/mattikummu/gini_gni_analyses"
  icon: fa-brands fa-github
- name: SubNGini Dataset
  url: "https://zenodo.org/records/16410778"
  icon: fas fa-table
# pub_status:
status: Forthcoming
