---
title: "SWIID Version 9.5 is available!"
author: Frederick Solt
date: '2023-06-27'
categories:
  - update
  - swiid
description: "Hi everyone! Version 9.5 of the SWIID is now available! This new release adds to its source data 169 new Ginis since version 9.4..."
---
...
-   adds to [its source data](https://github.com/fsolt/swiid/blob/master/data/swiid_source.csv) `r n_new_ginis` new Ginis since version `r last_version`, including newly available LIS data on [Canada, Luxembourg, and Spain](https://www.lisdatacenter.org/news-and-events/2023-spring-data-splash/) and on [Austria, Canada (again!), Italy, Sweden, and the United States](https://www.lisdatacenter.org/news-and-events/2023-summer-data-splash/); and
...
ggplot(data=brics, aes(x=year, y=gini_disp, colour=country)) +
  ...
  annotate("text", x = 2015, y = 21, size = 4, color="gray40", label="SWIID Version 9.5")
...
ggplot(swiid_last) +
  ...
  annotate("text", x = 44, y = 31, size=4, color="gray40", label="SWIID Version 9.5")
