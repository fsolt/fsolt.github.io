---
title: "SWIID Version 9.4 is available!"
author: Frederick Solt
date: '2022-11-22'
categories:
  - update
  - swiid
description: "Hi everyone! Version 9.4 of the SWIID is now available! This new release adds to its source data 5494 new Ginis since version 9.3..."
---
...
-   adds to [its source data](https://github.com/fsolt/swiid/blob/master/data/swiid_source.csv) `r n_new_ginis` new Ginis since version `r last_version`, including newly available LIS data on [Austria, China, Norway, Peru, the United Kingdom, Canada, and Chile](https://www.lisdatacenter.org/news-and-events/2022-autumn-data-splash/); and
...
ggplot(data=brics, aes(x=year, y=gini_disp, colour=country)) +
  ...
  annotate("text", x = 2015, y = 21, size = 4, color="gray40", label="SWIID Version 9.4")
...
ggplot(swiid_last) +
  ...
  annotate("text", x = 44, y = 31, size=4, color="gray40", label="SWIID Version 9.4")
