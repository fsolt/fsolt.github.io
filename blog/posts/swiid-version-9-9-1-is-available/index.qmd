---
title: "SWIID Version 9.91 is available!"
author: Frederick Solt
date: '2025-12-29'
categories:
  - update
  - swiid
description: "Hi everyone! Version 9.91 of the SWIID is now available! This new release adds to its source data nearly four thousand new Ginis since version 9.9..."
---
...
-   adds to [its source data](https://github.com/fsolt/swiid/blob/master/data/swiid_source.csv) `r n_new_ginis` new Ginis since version `r last_version`, including newly available LIS data on [France, Germany, Luxembourg, Switzerland, and Uruguay](https://www.lisdatacenter.org/news-and-events/2025-autumn-data-splash/) and 
on [Austria, Canada, Chile, Czechia, Ireland, Israel, Panama, the United States, and Switzerland (again!)](https://www.lisdatacenter.org/news-and-events/2025-winter-data-splash/); and
...
ggplot(data=brics, aes(x=year, y=gini_disp, colour=country)) +
  ...
  annotate("text", x = 2015, y = 21, size = 4, color="gray40", label="SWIID Version 9.91")
...
ggplot(swiid_last) +
  ...
  annotate("text", x = 44, y = 31, size=4, color="gray40", label="SWIID Version 9.91")
