---
title: "SWIID Version 9.6 is available!"
author: Frederick Solt
date: '2023-12-20'
categories:
  - update
  - swiid
description: "Hi everyone! Version 9.6 of the SWIID is now available! This new release adds to its source data over eight thousand new Ginis since version 9.5..."
---
...
-   adds to [its source data](https://github.com/fsolt/swiid/blob/master/data/swiid_source.csv) `r n_new_ginis` new Ginis since version `r last_version`, including newly available LIS data on [Georgia, Lithuania, Mexico, Norway, Romania, Sweden, Taiwan, and Uruguay](https://www.lisdatacenter.org/news-and-events/2023-autumn-data-splash/) and on [Belgium, Brazil, Israel, Italy, Luxembourg, Romania (again!), Switzerland, and the United Kingdom](https://www.lisdatacenter.org/news-and-events/2023-winter-data-splash/); and
...
ggplot(data=brics, aes(x=year, y=gini_disp, colour=country)) +
  ...
  annotate("text", x = 2015, y = 21, size = 4, color="gray40", label="SWIID Version 9.6")
...
ggplot(swiid_last) +
  ...
  annotate("text", x = 44, y = 31, size=4, color="gray40", label="SWIID Version 9.6")
