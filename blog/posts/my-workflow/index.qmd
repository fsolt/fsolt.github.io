...
I was excited for the invitation to speak at the workshop, because I think how we do our work is important: having a good workflow helps us to be more efficient, [to minimize errors](https://fsolt.org/res/working-papers/hutaisolt2022/), and so make our work more credible, which are all things to strive for.
...
- Presenting results: As soon as I read it, I was sold on the argument of @Kastellec2009 that we should always use plots instead of tables, and [Hu Yue](https://sammo3182.github.io/) and I wrote [dotwhisker](https://sammo3182.github.io/software/dotwhisker/) back in 2015 to make that easy. 
- Presenting quantities of interest: [Hu Yue](https://sammo3182.github.io/) and I also wrote the ([interplot](https://sammo3182.github.io/interplot/)) package to present the marginal effects plots needed to understand interaction terms.
...
Since I generate and publish [a lot](https://fsolt.org/swiid/) of data that I want people to discover, explore, and use, I include interactive graphics of these datasets on my websites.  There are other options, of course, but I use [Shiny](https://shiny.rstudio.com) to build these because it allows all the work to be done in R.
