---
title: "SWIID Version 9.3 is available!"
author: Frederick Solt
date: '2022-06-24'
categories:
  - update
  - swiid
description: "Hi everyone! Version 9.3 of the SWIID is now available! This new release adds to its source data 3834 new Ginis since version 9.2..."
---
...
-   adds to [its source data](https://github.com/fsolt/swiid/blob/master/data/swiid_source.csv) `r n_new_ginis` new Ginis since version `r last_version`, including newly available LIS data on [Canada, France, Ireland, Mali, Norway, Uruguay, Poland](https://www.lisdatacenter.org/news-and-events/2022-spring-data-splash/), [Germany, Luxembourg, Mali (again!), Peru, and the United States](https://www.lisdatacenter.org/news-and-events/2022-summer-data-splash/); and
...
ggplot(data=brics, aes(x=year, y=gini_disp, colour=country)) +
  ...
  annotate("text", x = 2015, y = 21, size = 4, color="gray40", label="SWIID Version 9.3")

ggsave("/Users/fredsolt/Documents/Projects/swiid/vignette/bric.pdf")
```
...
ggplot(swiid_last) +
  ...
  annotate("text", x = 44, y = 31, size=4, color="gray40", label="SWIID Version 9.3")

ggsave("/Users/fredsolt/Documents/Projects/swiid/vignette/highest_ineq.pdf")
```
