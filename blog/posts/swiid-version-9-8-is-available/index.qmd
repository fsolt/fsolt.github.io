---
title: "SWIID Version 9.8 is available!"
author: Frederick Solt
date: '2024-12-26'
categories:
  - update
  - swiid
description: "Hi everyone! Version 9.8 of the SWIID is now available! This new release adds to its source data nearly three thousand new Ginis since version 9.7..."
---
...
-   adds to [its source data](https://github.com/fsolt/swiid/blob/master/data/swiid_source.csv) `r n_new_ginis` new Ginis since version `r last_version`, including newly available LIS data on [Brazil, Canada, Georgia, Japan, Lithuania, Russia, Spain, and the United States](https://www.lisdatacenter.org/news-and-events/2024-winter-data-splash/) and 
<!-- on [Colombia (again!), France, Luxembourg, and Serbia](https://www.lisdatacenter.org/news-and-events/2024-summer-data-splash/); and -->
...
ggplot(data=brics, aes(x=year, y=gini_disp, colour=country)) +
  ...
  annotate("text", x = 2015, y = 21, size = 4, color="gray40", label="SWIID Version 9.8")
...
ggplot(swiid_last) +
  ...
  annotate("text", x = 44, y = 31, size=4, color="gray40", label="SWIID Version 9.8")
